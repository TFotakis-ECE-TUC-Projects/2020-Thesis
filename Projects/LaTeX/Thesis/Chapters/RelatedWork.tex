...
\begin{figure} [H]
	...
	\decoRule
	\caption[ResNet architecture]{ResNet architecture - Bottom: the VGG-19 model (19.6 GFLOPs) as a reference. Middle: a plain network with 34 parameter layers (3.6 GFLOPs). Top: a residual network with 34 parameter layers (3.6 GFLOPs). The dotted shortcuts increase dimensions.}
	\label{fig:ResNet}
\end{figure}
