...
Convolutional Neural Networks (CNN) are deep feedforward neural networks, ty\-pi\-cal\-ly used in visual imagery analysis. Some of their applications are image and video recognition, image classification, object detection, recommender systems, me\-di\-cal image analysis, natural language processing and financial time series.
