...
\begin{figure} [h]
	...
	\decoRule
	\caption[Google's TPU v3 - 4 chips, 2 cores per chip]{Google's TPU v3 - 4 chips, 2 cores per chip: \href{https://cloud.google.com/tpu/docs/system-architecture}{URL}}
...
\begin{figure} [h]
	...
	\decoRule
	\caption[FORTH QFDB, top-view (left) and bottom-view (right)]{FORTH QFDB, top-view (left) and bottom-view (right): \href{https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=8945720}{URL}}
