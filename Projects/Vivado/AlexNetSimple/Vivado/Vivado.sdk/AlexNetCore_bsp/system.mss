...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = Conv_Core
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Conv_Core_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Conv_Core
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Conv_Core_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Linear_Core
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Linear_Core_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Linear_Core
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Linear_Core_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MaxPool_Core
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MaxPool_Core_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MaxPool_Core
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MaxPool_Core_1
END
